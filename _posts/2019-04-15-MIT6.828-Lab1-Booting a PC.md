...
为了理解 main.c 的内容，需要 ELF 的预备知识，下面是 kernel 的 ELF header:

![](http://ww1.sinaimg.cn/large/c9caade4gy1g2a5igwqb3j217s0v07pg.jpg)
...
bootmain(void)
{
	...
	// 从 kernel 的第 0 个字节开始，拷贝 512 * 8 字节(即 8 个扇区到大小)到内存物理地址 0x10000 起始处
...
readseg(uint32_t pa, uint32_t count, uint32_t offset)
{
	...
	// 十进制的 511 用二进制表示为 0001 1111 1111
	pa &= ~(SECTSIZE - 1);
