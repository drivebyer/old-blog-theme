...
kernel 通过设置 %cr4 来启动处理器的 PSE 功能，启动后，虚拟地址的第 7 位被激活，利用该位来表示 PDE 是一个 page table 还是直接指向一个 super page，启动 PSE 前后的地址转换对比图见:[wikipedia:PSE](https://en.wikipedia.org/wiki/Page_Size_Extension)。
...
=======
>>>>>>> 73f83f6680f0fa0cae85a54e9b95e634ea89824c
