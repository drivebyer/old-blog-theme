...
这个 GDT 表设置了 3 个 segment descriptor，其中 code seg 和 data seg 的 base address=0 且 limit=0xFFFFFFFF，这就意味着在这个 GDT 的映射下，virtual address 与 linear address 在数值上是相等的。
